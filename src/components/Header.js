                      ...
                      >
                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          {userNavigation.map((item) => (
                            <Disclosure.Button key={item.name} as="a" href={item.href} className="block px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-gray-700">
                              {item.name}
                            </Disclosure.Button>
                          ))}
                          <button onClick={() => auth.logout()} className="block px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-gray-700 w-full text-left">
                            Logout
                          </button>
                        </Menu.Items>
                      </Transition>
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                ...
                <div className="mt-3 px-2 space-y-1">
                  ...
                  <button onClick={() => auth.logout()} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700 w-full text-left">
                    Logout
                  </button>
                </div>
              </div>
